# -*- coding: utf-8 -*-
"""
Created on Fri May 11 16:55:30 2018
...
#2.读取训练数据并创建Dataset
# 使用Dataset从一个文件中读取一个语言的数据。此方法比较方便
...
def MakeSrcTrgDataset(src_path,trg_path,batch_size):
    ...
    def FilterLength(src_tuple, trg_tuple): #src_tuple, trg_tuple是dataset中的数据
    ...
    dataset = dataset.filter(FilterLength) # 调用内部函数
...
class NMTModel(object):
    ...
    def forward(self,src_input, src_size, trg_input, trg_label, trg_size):
        batch_size=tf.shape(src_input)[0] #每个句子训练一次
